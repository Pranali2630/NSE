...
public function submitForm(array &$form, FormStateInterface $form_state)
  ...
  $query = \Drupal::database();
    ...
    ->condition('nc.date', array($from,  $to), 'BETWEEN');
    ...
    echo "</br>________________________________________________________________";
  ...
  $query = \Drupal::database();
    ...
    $query = \Drupal::database();
    $selectquery = $query->select('nse_fii','nc');
    $selectquery->fields('nc', ['FII_id','Date','FI_Long','FI_Short']);
    $or_group = $selectquery->orConditionGroup()
    ->condition('nc.date', $from, '<');
    $selectquery->condition($or_group);
    $result = $selectquery->execute();
  ...
  $query = \Drupal::database();
    ...
    $query = \Drupal::database();
    $selectquery = $query->select('nse_pro','nc');
    $selectquery->fields('nc', ['Pro_id','Date','FI_Long','FI_Short']);
    $or_group = $selectquery->orConditionGroup()
    ->condition('nc.date', $from, '<');
    $selectquery->condition($or_group);
    $result = $selectquery->execute();
